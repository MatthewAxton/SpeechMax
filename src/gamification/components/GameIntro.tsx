        ...
        right={
          <div
            style={{
              ...
              alignItems: 'center',
              gap: 8,
              background: 'rgba(194,143,231,0.15)',
              borderRadius: 20,
              padding: '4px 14px',
              fontSize: 13,
              color: '#c28fe7',
      ...
      >
              ...
              >
                <div
                  style={{
                    ...
                    height: 28,
                    borderRadius: '50%',
                    background: 'rgba(194,143,231,0.2)',
                    color: '#c28fe7',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                ...
                <div style={{ color: 'rgba(255,255,255,0.8)', fontSize: 14, lineHeight: 1.5, paddingTop: 3 }}>
                  {step}
                </div>
              </motion.div>
            ))}
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: 14,
            padding: '14px 18px',
            border: '1px solid rgba(194,143,231,0.15)',
          }}
        >
          <div style={{ color: '#c28fe7', fontSize: 11, fontWeight: 700, letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 4 }}>
            Goal
          </div>
